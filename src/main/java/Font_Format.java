...
public class Font_Format extends JDialog implements ActionListener{
     ...
     * 英文预览的字符串
     */
    private static final String ENGLISH_STRING = "HelloWorld";
    /**
     * 数字预览的字符串
     */
    ...
    public void Font_source(Font font) {
        setTitle("字体选择器");
        this.font = font;
        // 初始化UI组件
        init();
     ...
     */
    public final int showFontDialog(Font_Format owner) {
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()== Mytext.FontSet){
            Font_Format font_s=new Font_Format(Mytext.myTextArea.getFont());
            font_s.showFontDialog(this);
            Font thisfont=font_s.getSelectFont();
            Mytext.myTextArea.setFont(thisfont);
        }
    }
